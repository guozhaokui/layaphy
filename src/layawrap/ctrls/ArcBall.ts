...
export class ArcBall {
    ...
    private lastPos: Vector3 = new Vector3(); // 上次的点的位置，是已经规格化的了
    private curPos: Vector3 = new Vector3();
    //private halfPos: Vector3 = new Vector3();

    private newQuat: Quaternion = new Quaternion();
    protected static e: number = 1e-6;
